...
public class ToDoListApp {
    public static final String FILE_JSON = "src/main/java/serialization/database/tasks/tasks.json";
    public static final String FILE_BIN = "src/main/java/serialization/database/tasks/tasks.bin";
    public static final String FILE_XML = "src/main/java/serialization/database/tasks/tasks.xml";
    ...
    public static void markTaskASDone(Scanner scanner, List<ToDo> tasks){
     ...
     public static void exit(Scanner scanner, List<ToDo> tasks){
         saveTasksToFile(FILE_JSON, tasks);
         saveTasksToFile(FILE_BIN, tasks);
         saveTasksToFile(FILE_XML, tasks);
